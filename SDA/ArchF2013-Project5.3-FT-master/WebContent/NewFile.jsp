...
<form action="/javaserver/credit/updateUserCredit" method="POST">
<div class = "container">
<div class="row">
  <div class="span4">
  <h4>Enter user : </h4>
  ...
  <div class="span7">
  <input type="text" name="user" placeholder="Enter use ID" class="input-large" id="focusedInput" style="font-size:12pt;height:30px">
  </div>
</div>
<br />
<div class="row">
